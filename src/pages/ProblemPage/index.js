...
class ProblemPage extends React.Component {
    get_problem_info = () => {
        ...
        let url = 
            `http://127.0.0.1:8000/JudgeOnline/api/missions/${match.params.mission_id}/problems/${match.params.problem_id}/`;
        fetch(url, {
            method: 'get',
            credentials: 'include'
    ...
    submit = (code) => {
        ...
        let url = `http://127.0.0.1:8000/JudgeOnline/api/missions/${match.params.mission_id}/submissions/`;
